...
module.exports = function (client) {
    ...
    client.on("voiceStateUpdate", (oldState, newState) => {
        ...
        if (!oldState.channelID && newState.channelID) {
            if (newState.channelID !== config.JOINTOCREATE) return;
        ...
        if (oldState.channelID && newState.channelID) {
            ...
            if (oldState.channelID !== newState.channelID) {
                if (newState.channelID === config.JOINTOCREATE)
    ...
    async function jointocreatechannel(user) {
        ...
        await user.guild.channels.create(`Random  ${user.member.user.username}`, {
            type: 'voice',
